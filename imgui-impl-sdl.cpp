...
//  2023-02-07: *BREAKING CHANGE* Renamed this backend file from imgui_impl_sdl.cpp/.h to imgui-impl-sdl.cpp/.h in prevision for the future release of SDL3.
...
static bool ImGui_ImplSDL2_Init(SDL_Window* window, SDL_Renderer* renderer, void* sdl_gl_context)
{
    ...
    snprintf(bd->BackendPlatformName, sizeof(bd->BackendPlatformName), "imgui-impl-sdl (%u.%u.%u, %u.%u.%u)",
