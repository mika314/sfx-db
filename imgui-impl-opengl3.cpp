...
// - For other targets, the define needs to be visible from the imgui-impl-opengl3.cpp compilation unit. If unsure, define globally or in imconfig.h.
...
//  2024-01-09: OpenGL: Update GL3W based imgui-impl-opengl3-loader.h to load "libGL.so" and variants, fixing regression on distros missing a symlink.
//  2023-11-08: OpenGL: Update GL3W based imgui-impl-opengl3-loader.h to load "libGL.so" instead of "libGL.so.1", accommodating for NetBSD systems having only "libGL.so.3" available. (#6983)
...
//  2021-08-19: OpenGL: Embed and use our own minimal GL loader (imgui-impl-opengl3-loader.h), removing requirement and support for third-party loader.
...
//  2018-06-08: Misc: Extracted imgui-impl-opengl3.cpp/.h away from the old combined GLFW/SDL+OpenGL3 examples.
...
// If you happen to be developing a new feature for this backend (imgui-impl-opengl3.cpp):
// - You may need to regenerate imgui-impl-opengl3-loader.h to add new symbols. See https://github.com/dearimgui/gl3w_stripped
//   Typically you would run: python3 ./gl3w_gen.py --output ../imgui/backends/imgui-impl-opengl3-loader.h --ref ../imgui/backends/imgui-impl-opengl3.cpp ./extra_symbols.txt
